...
// TODO: Figure out if it's possible to require trait InhabitsT<Self::AbstractTypeType>
pub trait TermT: Any + Clone + Debug + Send + Sized + Sync {
    ...
    // TODO: Maybe the bound on this could be `where Self: InhabitsT<Self::AbstractTypeType>`
    type AbstractTypeType: TermT;
    ...
    // TODO: Make dy::ParametricityT with this method, and then have st::NonParametricTermT
    // and st::ParametricTermT which both implement that.
    ...
    // TODO: Make dy::TypefulnessT with this method, and then have st::NonTypeT
    // and st::TypeT which both implement that.
...
// TODO: Implement derive macro for deriving TermT
