...
macro_rules! for_each_parametric_term {
    ($T:ident, $e:expr) => {
        (
            {
                type T = $crate::dy::ArrayTerm;
                $e
            },
            {
                type T = $crate::dy::GlobalSymRefTerm;
                $e
            },
            //             { type T = $crate::dy::LocalSymRefTerm;                  $e },
            {
                type T = $crate::dy::StructTerm;
                $e
            },
            {
                type T = $crate::dy::StructTermTerm;
                $e
            },
            {
                type T = $crate::dy::TupleTerm;
                $e
            },
            // TODO: Should this just be bool?  BoolTerm is a type alias for bool.
            {
                type T = $crate::st::BoolTerm;
                $e
            },
            {
            ...
            {
                type T = $crate::st::Sint16Term;
                $e
            },
            {
                type T = $crate::st::Sint32Term;
                $e
            },
            {
                type T = $crate::st::Sint64Term;
                $e
            },
            {
                type T = $crate::st::Uint8Term;
                $e
            },
            {
                type T = $crate::st::Uint16Term;
                $e
            },
            {
                type T = $crate::st::Uint32Term;
                $e
            },
            {
                type T = $crate::st::Uint64Term;
                $e
            },
            {
