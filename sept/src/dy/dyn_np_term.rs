...
//     type AbstractTypeFnReturnType = Value;
    type AbstractTypeFnReturnType = Box<dy::ValueGuts>;
...
//             DynNPTerm::FormalTypeOf,
            ...
            DynNPTerm::Float32 => FLOAT32.is_parametric_term(),
            DynNPTerm::Float64 => FLOAT64.is_parametric_term(),
            ...
            DynNPTerm::Float32Type => FLOAT32_TYPE.is_parametric_term(),
            DynNPTerm::Float64Type => FLOAT64_TYPE.is_parametric_term(),
//             DynNPTerm::SintType,
//             DynNPTerm::Sint,
//             DynNPTerm::UintType,
//             DynNPTerm::Uint,
...
//             DynNPTerm::Difference,
            DynNPTerm::ArrayType => ARRAY_TYPE.is_parametric_term(),
//             DynNPTerm::ArrayES,
//             DynNPTerm::ArrayE,
//             DynNPTerm::ArrayS,
            DynNPTerm::Array => ARRAY.is_parametric_term(),
...
//             DynNPTerm::FormalTypeOf,
            ...
            DynNPTerm::Float32 => FLOAT32.is_type_term(),
            DynNPTerm::Float64 => FLOAT64.is_type_term(),
            ...
            DynNPTerm::Float32Type => FLOAT32_TYPE.is_type_term(),
            DynNPTerm::Float64Type => FLOAT64_TYPE.is_type_term(),
//             DynNPTerm::SintType,
//             DynNPTerm::Sint,
//             DynNPTerm::UintType,
//             DynNPTerm::Uint,
...
//             DynNPTerm::Negation,
//             DynNPTerm::Difference,
            DynNPTerm::ArrayType => ARRAY_TYPE.is_type_term(),
//             DynNPTerm::ArrayES,
//             DynNPTerm::ArrayE,
//             DynNPTerm::ArrayS,
